...
### Next step (important for winning)

Your README is now **judge-level**.

Next, the **MOST critical part** to win is:

➡️ **3-minute demo script** (this decides top-3 vs normal team)

Say:

**“give demo script”**

and I’ll write a **cinematic winning narration**.
```
